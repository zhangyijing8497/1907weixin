                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="{{url('media/show')}}">素材列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('new/create')}}">新闻添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('new/index')}}">新闻列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('chart/index')}}">渠道图表</a>
                            </li>
                        </ul>
                    </li>
                </ul>
